												...
												<div class="avatar-group-item">
													<Link href="#!">
														<div class="avatar-xxs">
															<span class={'avatar-title rounded-circle text-white ' + item.bgcolor}>
																{item.imgNumber}
															</span>
														</div>
													</Link>
						...
						<div data-simplebar style="max-height: 364px;" class="p-3">
							<div class="acitivity-timeline acitivity-main m-0">
								...
								<div class="acitivity-item py-3 d-flex">
									...
									<div class="flex-grow-1 ms-3">
										<h6 class="mb-1">
											Added new <span class="fw-bold">style collection</span>
										</h6>
...
<Row>
	{#each chartDataOptions as item}
		<Col xl={4} md={6}>
			<Card class="card-height-100">
				<div class="d-flex">
					<div class="flex-grow-1 p-3">
						<h5 class="mb-3">{item.title}</h5>
						<p class="mb-0 text-muted"><span class="badge bg-light text-success mb-0"> <i class="ri-arrow-up-line align-middle"></i> {item.persantage} % </span> vs. previous month</p>
					</div>
					<div>
						<OtherWidgetsCharts dataColors={item.dataColors} id={item.id} seriesData={item.series} />
					</div>
				</div>
			</Card>
		</Col>
