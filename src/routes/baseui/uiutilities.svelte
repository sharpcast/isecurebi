...
<svelte:head>
	<title>Utilities | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
						...
						<div class="live-preview">
							<div>
								<div>
									...
									<div
										class="d-flex align-items-start flex-wrap gap-4"
									>
								...
								<div class="mt-4">
									...
									>
										<div class="text-center">
											<div
												class="border border-primary avatar-md bg-light mx-auto mb-1"
											/>
										...
										<div class="text-center">
											<div
												class="border border-success avatar-md bg-light mx-auto mb-1"
											/>
											<p><code>.border-success</code></p>
										</div>
										<div class="text-center">
											<div
												class="border border-info avatar-md bg-light mx-auto mb-1"
											/>
											<p><code>.border-info</code></p>
										</div>
										<div class="text-center">
											<div
												class="border border-warning avatar-md bg-light mx-auto mb-1"
											/>
											<p><code>.border-warning</code></p>
										</div>
										<div class="text-center">
											<div
												class="border border-danger avatar-md bg-light mx-auto mb-1"
											/>
											<p><code>.border-danger</code></p>
										</div>
										<div class="text-center">
											<div
												class="border border-dark avatar-md bg-light mx-auto mb-1"
											/>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use below-mentioned class to an element to display
						...
						<div class="live-preview">
							...
							<div class="mt-4">
								...
								<p class="text-muted">
									Change the display value of elements when
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use the below-mentioned class to an element to
		...
		<Row>
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted mb-3">
							Use <code>vstack</code> class to create vertical
						...
						<div class="live-preview">
							<div class="vstack gap-3">
								<div class="bg-light border p-1 px-2">
									First item
								</div>
								<div class="bg-light border p-1 px-2">
									Second item
			...
			<Col xxl={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted mb-3">
							Use <code>hstack</code> class to create horizontal
							layouts. Stacked items are full-width by default.
							Use <code>gap-</code> class with variation to add space
							between items.
						</p>
						...
						<div class="live-preview">
							...
							<div class="mt-4">
								...
								<div class="hstack gap-3">
									...
									<div
										class="bg-light border p-1 px-2 ms-auto"
									>
										Second item
									</div>
									<div class="bg-light border p-1 px-2">
						...
						<div class="live-preview">
							<div>
								<p class="user-select-all">
									This paragraph will be entirely selected
								...
								<p class="user-select-none mb-0">
									This paragraph will not be selectable when
									clicked by the user.
								</p>
							</div>
						</div>
							...
							<div>
								<p>
									<Link
										...
										tabIndex="-1">This link</Link
									> can not be clicked.
								</p>
								<p>
									<Link href="#!" class="text-success pe-auto"
										>This link</Link
								...
								<Row>
									<Col xl={3} sm={6}>
										<div class="mt-4 mt-xl-0">
											...
											<div class="d-md-flex bg-light">
												<div
													class="overflow-auto p-3 mb-0 bg-light"
													style="height: 100px"
												>
									...
									<Col xl={3} sm={6}>
										<div class="mt-4 mt-xl-0">
											...
											<div class="d-md-flex bg-light">
												<div
													class="overflow-hidden p-3 mb-0 bg-light"
													style="height: 100px"
												>
									...
									<Col xl={3} sm={6}>
										<div class="mt-4 mt-xl-0">
											...
											<div class="d-md-flex bg-light">
												<div
													class="overflow-visible p-3 mb-0 bg-light"
													style="height: 100px"
												>
													This is an example of using
													<code
									...
									<Col xl={3} sm={6}>
										<div class="mt-4 mt-xl-0">
											...
											<div class="d-md-flex bg-light">
												<div
													class="overflow-scroll p-3 mb-0 bg-light"
													style="height: 100px"
												>
													This is an example of using
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							...
							in Bootstrap and can be enabled via <code
								>$enable-shadows</code
						...
						<div class="live-preview">
							<Row class="gy-3">
								<Col md={6}>
									<div
										class="shadow-none p-3 bg-light rounded"
									>
										No shadow
									</div>
								</Col>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="row text-center" style="height: 255px">
								<Col class="col">
									<div class="h-25 p-3 bg-light">
										Height25%
									</div>
								</Col>
								<Col class="col">
									<div class="h-50 p-3 bg-light">
										Height 50%
									</div>
								</Col>
								<Col class="col">
									<div class="h-75 p-3 bg-light">
										Height 75%
									</div>
								</Col>
								<Col class="col">
