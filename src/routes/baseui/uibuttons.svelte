...
<svelte:head>
	<title>Buttons | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use the <code>rounded-pill </code>class to make a
							rounded button.
						</p>
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<Button color="primary" class="rounded-pill"
									>Primary</Button
								>
								<Button color="secondary" class="rounded-pill"
									>Secondary</Button
								>
								<Button color="success" class="rounded-pill"
									>Success</Button
								>
								<Button color="info" class="rounded-pill"
									>Info</Button
								>
								<Button color="warning" class="rounded-pill"
									>Warning</Button
								>
								<Button color="danger" class="rounded-pill"
									>Danger</Button
								>
								<Button color="dark" class="rounded-pill"
									>Dark</Button
								>
								<Button color="light" class="rounded-pill"
									>Light</Button
								>
							</div>
						</div>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<Button class="btn-soft-primary">Primary</Button
								>
								<Button class="btn-soft-secondary"
									>Secondary</Button
								>
								<Button class="btn-soft-success">Success</Button
								>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								...
								<Button
									color="info"
									outline
									class="btn btn-ghost-info">Info</Button
								>
								<Button
									color="warning"
									outline
								...
								<Button
									color="danger"
									outline
									class="btn btn-ghost-danger">Danger</Button
								>
								<Button
									color="dark"
									outline
									class="btn btn-ghost-dark">Dark</Button
								>
							</div>
						</div>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>bg-gradient </code>class to create a
							gradient button.
						</p>
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<Button color="primary" class="bg-gradient"
									>Primary</Button
								>
								<Button color="secondary" class="bg-gradient"
									>Secondary</Button
								>
								<Button color="success" class="bg-gradient"
									>Success</Button
								>
								<Button color="info" class="bg-gradient"
									>Info</Button
								>
								<Button color="warning" class="bg-gradient"
									>Warning</Button
								>
								<Button color="danger" class="bg-gradient"
									>Danger</Button
								>
								<Button color="dark" class="bg-gradient"
									>Dark</Button
								>
								<Button color="light" class="bg-gradient"
									>Light</Button
								>
							</div>
						</div>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>bg-animation </code>class to create an
							animated button.
						</p>
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>btn-label </code>class to create a button
							with the label.
						</p>
						<div class="live-preview">
							<Row>
								<Col lg={4}>
									...
									>
										...
										>
											<i
												class="ri-user-smile-line label-icon align-middle fs-16 me-2"
											/> Primary
										</Button>
										<Button
											color="success"
								...
								<Col lg={4}>
									<div class="d-flex flex-wrap gap-2">
										...
										>
											<i
												class="ri-user-smile-line label-icon align-middle fs-16 ms-2"
											/> Primary
										</Button>
										<Button
											color="success"
					...
					<CardBody>
						...
						<div class="live-preview">
							<Row>
								<Col lg={6}>
									<div class="d-flex flex-wrap align-items-center gap-2">
										<Button color='primary' class="custom-toggle active" on:click={(e) => favouriteBtn(e.target)}>
											<span class="icon-on"><i class="ri-alarm-line align-bottom"></i> Active</span>
											<span class="icon-off">Unactive</span>
										</Button>
										<Button color='secondary' class="custom-toggle active" on:click={(e) => favouriteBtn(e.target)}>
											<span class="icon-on"><i class="ri-user-add-line align-bottom me-1"></i> Connect</span>
											<span class="icon-off"><i class="ri-check-fill align-bottom me-1"></i> Unconnect</span>
										</Button>
										<Button color='success' class="custom-toggle" on:click={(e) => favouriteBtn(e.target)}>
											<span class="icon-on"><i class="ri-thumb-up-line align-bottom me-1"></i> Yes</span>
											<span class="icon-off"><i class="ri-thumb-down-line align-bottom me-1"></i> No</span>
										</Button>
										<Button color='warning' class="custom-toggle active" on:click={(e) => favouriteBtn(e.target)}>
											<span class="icon-on"><i class="ri-add-line align-bottom me-1"></i> Follow</span>
											<span class="icon-off"><i class="ri-user-unfollow-line align-bottom me-1"></i> Unfollow</span>
										</Button>
										<Button color='danger' class="custom-toggle" on:click={(e) => favouriteBtn(e.target)}>
											<span class="icon-on">On</span>
											<span class="icon-off">Off</span>
										</Button>
										<Button color='dark' class="custom-toggle" on:click={(e) => favouriteBtn(e.target)}>
											<span class="icon-on"><i class="ri-bookmark-line align-bottom me-1"></i> Bookmark</span>
											<span class="icon-off"><i class="ri-bookmark-3-fill align-bottom me-1"></i> Unbookmark</span>
										</Button>
									</div>
								...
								<Col lg={6}>
									<div class="d-flex flex-wrap align-items-center gap-2">
										<Button color="primary" outline class="custom-toggle" on:click={(e) => favouriteBtn(e.target)}>
											<span class="icon-on">Active</span>
											<span class="icon-off">Unactive</span>
										</Button>
										<Button color="secondary" outline class="custom-toggle" on:click={(e) => favouriteBtn(e.target)}>
											<span class="icon-on"><i class="ri-add-line align-bottom me-1"></i> Follow</span>
											<span class="icon-off"><i class="ri-user-unfollow-line align-bottom me-1"></i> Unfollow</span>
										</Button>
										<Button color="success" outline class="custom-toggle active" on:click={(e) => favouriteBtn(e.target)}>
											<span class="icon-on">On</span>
											<span class="icon-off">Off</span>
										</Button>
										<Button color="warning" outline class="custom-toggle active" on:click={(e) => favouriteBtn(e.target)}>
											<span class="icon-on">Follow</span>
											<span class="icon-off">Unfollow</span>
										</Button>
										<Button color="danger" outline class="custom-toggle" on:click={(e) => favouriteBtn(e.target)}>
											<span class="icon-on">On</span>
											<span class="icon-off">Off</span>
										</Button>
										<Button color="dark" outline class="custom-toggle active" on:click={(e) => favouriteBtn(e.target)}>
											<span class="icon-on"><i class="ri-bookmark-line align-bottom"></i></span>
											<span class="icon-off"><i class="ri-bookmark-3-fill align-bottom"></i></span>
										</Button>
									</div>
				...
				<Card>
					...
					<CardBody>
						...
						<div class="live-preview">
							<div class="d-flex flex-wrap gap-2">
								<Button color="primary" class="w-xs">Xs</Button>
								<Button color="danger" class="w-sm"
									>Small</Button
								>
								<Button color="warning" class="w-md"
									>Medium</Button
								>
								<Button color="success" class="w-lg"
									>Large</Button
								>
							</div>
						</div>
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>d-grid</code> class to create a full-width
							block button.
						</p>
						<div class="live-preview">
							<div class="d-grid gap-2">
				...
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							...
							<a
								href="//getbootstrap.com/docs/5.1/forms/checks-radios/"
								>toggle buttons</a> into a seamless looking button group.
						</p>
						<div class="live-preview">
							<div class="d-flex flex-wrap align-items-center gap-2">
								<ButtonGroup>
									...
									<Button
										color="primary"
										class="mb-0"
										id="btncheck1">Checkbox 1</Button
									>
									...
									<Button
										color="primary"
										class="mb-0"
										id="btncheck2">Checkbox 2</Button
									>
									...
									<Button
										color="primary"
										class="mb-0"
										id="btncheck3">Checkbox 3</Button
									>
								</ButtonGroup>
		...
		<Row>
			<Col lg={6}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use the <code>btn-group </code> class in the parent class
						...
						<div class="live-preview">
							<Row>
								...
								<Col sm={6}>
									<ButtonGroup class="mt-4 mt-sm-0">
										<Button color="light" class="btn-icon"
											><i
							...
							<Row>
								<Col sm={6}>
									<div class="hstack gap-2 ">
										<Button color="primary" class="btn-icon"
											><i
		...
		<Row>
			<Col lg={12}>
				<Card>
					...
					<CardBody>
						<p class="text-muted">
							Use <code>btn-toolbar</code> class to combine sets of
