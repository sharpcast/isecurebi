<svelte:head>
  <title>Candidates List View | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
<script>
                    ...
                    <CardBody class="card-body">
                        ...
                        <div class="flex-shrink-0">
                            ...
                            <div class="avatar-sm rounded">
                                <div class="avatar-title border bg-light text-primary rounded text-uppercase fs-16">
                                {item.nickname}
                                </div>
                            </div>
                            {:else}
                        ...
                        <div>
                            <Link href="#!" class="btn btn-soft-success me-1">
                            View Details
                            </Link>
                            <Link
                            href="#!"
                            ...
                            class={isBookmarkClick ? "btn btn-ghost-danger btn-icon custom-toggle active" : "btn btn-ghost-danger btn-icon custom-toggle"}
                            >
                            {#if !isBookmarkClick}
                                <span class="icon-on">
