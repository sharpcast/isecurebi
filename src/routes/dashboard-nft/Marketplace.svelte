<script>
import { Card, CardBody, CardHeader, Col, DropdownItem, DropdownMenu, DropdownToggle, Row, Dropdown } from 'sveltestrap';
                    ...
                    <Col xxl={4}>
                        <div class="border-start p-4 h-100 d-flex flex-column">
                            ...
                            <div class="w-100">
                                <div class="d-flex align-items-center">
                                    ...
                                    <Dropdown>
                                        ...
                                        <DropdownMenu class="dropdown-menu-end" end>
                                            <DropdownItem href="#!"><i class="ri-twitter-fill text-primary align-bottom me-1"></i> Twitter</DropdownItem>
                                            <DropdownItem href="#!"><i class="ri-facebook-circle-fill text-info align-bottom me-1"></i> Facebook</DropdownItem>
                                            <DropdownItem href="#!"><i class="ri-google-fill text-danger align-bottom me-1"></i> Google</DropdownItem>
                                        </DropdownMenu>
                                    </Dropdown>
                                ...
                                <Row class="mt-4 pt-2">
                                    <Col>
                                        <Link href="/NFTmarketplace/Itemdetails/apps-nft-item-details" class="btn btn-primary w-100">View Details</Link>
                                    </Col>
                                    <Col>
