<svelte:head>
  <title>Timeline | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
<script>
					...
					<div class="timeline">
										...
										<div class="d-flex border border-dashed p-2 rounded position-relative">
											...
											<div class="flex-grow-1 overflow-hidden ms-2">
												<h6 class="text-truncate mb-0">
													<Link href="#!" class="stretched-link">Business Template - UI/UX design</Link
													>
												</h6>
												<small>685 KB</small>
											</div>
						...
						<div class="timeline-item left">
							...
							<div class="content">
								...
								<p class="text-muted">
									Every team project can have a velzon. Use the velzon to share information with
						...
						<div class="timeline-item right">
							...
							<div class="content">
								<h5>
									Donald Palmer <small class="text-muted fs-13 fw-normal"
							...
							<div class="content">
								<h5>
									New ticket received <span
										class="badge bg-soft-success text-success fs-10 align-middle ms-1"
										>Completed</span
									>
								</h5>
								<p class="text-muted mb-2">
