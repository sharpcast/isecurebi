<svelte:head>
  <title>Terms & Condition | Velzon - Svelte Admin & Dashboard Template</title>
</svelte:head>
<script>
          ...
          <Card>
            ...
            <CardBody class="p-4">
              ...
              <div>
                ...
                <p class="text-muted">
                  Approved organizations may hyperlink href our Website as
                  follows:
                </p>
                <ul class="text-muted vstack gap-2">
              ...
              <div class="text-end">
                <Link href="#!" class="btn btn-primary me-1">
                  Accept
                </Link>
                <Link href="#!" class="btn btn-outline-danger">
