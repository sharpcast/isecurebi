				...
				<div>
					<div class="d-flex">
						...
						<div class="flex-shrink-0">
							<Link href="/pages/profile/settings/pages-profile-settings" class="btn btn-info">
												...
												<Col xs={6} md={4}>
													<div class="d-flex mt-4">
														...
														<div class="flex-grow-1 overflow-hidden">
															...
															<Link href="{null}" class="fw-semibold">www.velzon.com</Link>
														</div>
													</div>
												</Col>
											</Row>
									...
									<Row>
										<Col lg={12}>
																...
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a
																				href="{null}" class="link-dark">Artboard-documents.zip</a>
																		</h6>
																	</div>
																</div>
															</td>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a
																				href="{null}" class="link-dark">Bank
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a
																				href="{null}" class="link-dark">Tour-video.mp4</a>
																		</h6>
																	</div>
																</div>
															</td>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a
																				href="{null}" class="link-dark">Account-statement.xsl</a>
																		</h6>
																	</div>
																</div>
															</td>
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a
																				href="{null}" class="link-dark">Project
														...
														<tr>
															<td>
																<div class="d-flex align-items-center">
																	...
																	<div class="ms-3 flex-grow-1">
																		<h6 class="fs-15 mb-0"><a
																				href="{null}" class="link-dark">Velzon-logo.png</a>
																		</h6>
																	</div>
																</div>
															</td>
											...
											<div class="text-center mt-3">
												<Link href="{null}" class="text-info"
