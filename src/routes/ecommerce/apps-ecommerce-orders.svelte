...
<script>
	import { Container, Row, Col, Card, CardBody, Input, Modal, ModalBody, Label, ModalHeader } from 'sveltestrap';
							...
							<form action="#">
								...
								<div class="modal-footer">
									<div class="hstack gap-2 justify-content-end">
										...
										<button type="submit" class="btn btn-success" id="add-btn" on:click={toggle}>Add Order</button>
									</div>
								</div>
							</form>
						</Modal>
