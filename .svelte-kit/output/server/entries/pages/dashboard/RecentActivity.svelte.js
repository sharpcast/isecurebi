import { c as create_ssr_component, d as compute_rest_props, f as spread, j as escape_object, h as escape_attribute_value, l as escape, k as add_attribute, e as createEventDispatcher, s as setContext, o as onDestroy, t as tick, g as getContext, v as validate_component, p as each$1 } from "../../../chunks/index-aeca7bd0.js";
...
import { i as img2, a as img8$1, b as img2$1, c as img1, M as MOCK_DATA } from "../../../chunks/dashboardEcommerce-24a648c7.js";
import { b as avatar3, a as avatar2 } from "../../../chunks/avatar-3-138d7757.js";
...
const Progress = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  classes2 = classnames(className, "progress");
...
var swiper_min = "";
var pagination_min = "";
const ReviewSlider = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      return `${validate_component(Swiper_slide, "SwiperSlide").$$render($$result, {}, {}, {
        default: () => {
          return `${validate_component(Card, "Card").$$render($$result, {
            class: "border border-dashed shadow-none"
          }, {}, {
            default: () => {
              return `${validate_component(CardBody, "CardBody").$$render($$result, {}, {}, {
                default: () => {
                  return `<div class="${"d-flex"}"><div class="${"flex-shrink-0 avatar-sm"}"><div class="${"avatar-title bg-light rounded"}"><img${add_attribute("src", img2, 0)} alt="${""}" height="${"30"}"></div></div>
					<div class="${"flex-grow-1 ms-3"}"><div><p class="${"text-muted mb-1 fst-italic text-truncate-two-lines"}">&quot; Great product and looks great, lots of
								features. &quot;
							</p>
							<div class="${"fs-11 align-middle text-warning"}"><i class="${"ri-star-fill"}"></i>
								<i class="${"ri-star-fill"}"></i>
								<i class="${"ri-star-fill"}"></i>
								<i class="${"ri-star-fill"}"></i>
								<i class="${"ri-star-fill"}"></i></div></div>
						<div class="${"text-end mb-0 text-muted"}">- by <cite title="${"Source Title"}">Force Medicines</cite></div></div></div>`;
                }
              })}`;
            }
          })}`;
        ...
        default: () => {
          return `${validate_component(Card, "Card").$$render($$result, {
            ...
            default: () => {
              return `${validate_component(CardBody, "CardBody").$$render($$result, {}, {}, {
                default: () => {
                  return `<div class="${"d-flex"}"><div class="${"flex-shrink-0"}"><img${add_attribute("src", avatar3, 0)} alt="${""}" class="${"avatar-sm rounded"}"></div>
					<div class="${"flex-grow-1 ms-3"}"><div><p class="${"text-muted mb-1 fst-italic text-truncate-two-lines"}">&quot; Amazing template, very easy to understand and
								manipulate. &quot;
							</p>
							<div class="${"fs-11 align-middle text-warning"}"><i class="${"ri-star-fill"}"></i>
								<i class="${"ri-star-fill"}"></i>
						...
						<div class="${"text-end mb-0 text-muted"}">- by <cite title="${"Source Title"}">Henry Baird</cite></div></div></div>`;
                }
              })}`;
            }
          })}`;
        ...
        default: () => {
          return `${validate_component(Card, "Card").$$render($$result, {
            ...
            default: () => {
              return `${validate_component(CardBody, "CardBody").$$render($$result, {}, {}, {
                default: () => {
                  return `<div class="${"d-flex"}"><div class="${"flex-shrink-0 avatar-sm"}"><div class="${"avatar-title bg-light rounded"}"><img${add_attribute("src", img8$1, 0)} alt="${""}" height="${"30"}"></div></div>
					<div class="${"flex-grow-1 ms-3"}"><div><p class="${"text-muted mb-1 fst-italic text-truncate-two-lines"}">&quot;Very beautiful product and Very helpful
								customer service.&quot;
							</p>
							<div class="${"fs-11 align-middle text-warning"}"><i class="${"ri-star-fill"}"></i>
								<i class="${"ri-star-fill"}"></i>
								...
								<i class="${"ri-star-line"}"></i></div></div>
						<div class="${"text-end mb-0 text-muted"}">- by <cite title="${"Source Title"}">Zoetic Fashion</cite></div></div></div>`;
                }
              })}`;
            }
          })}`;
        ...
        default: () => {
          return `${validate_component(Card, "Card").$$render($$result, {
            ...
            default: () => {
              return `${validate_component(CardBody, "CardBody").$$render($$result, {}, {}, {
                default: () => {
                  return `<div class="${"d-flex"}"><div class="${"flex-shrink-0"}"><img${add_attribute("src", avatar2, 0)} alt="${""}" class="${"avatar-sm rounded"}"></div>
					<div class="${"flex-grow-1 ms-3"}"><div><p class="${"text-muted mb-1 fst-italic text-truncate-two-lines"}">&quot; The product is very beautiful. I like it. &quot;
							</p>
							<div class="${"fs-11 align-middle text-warning"}"><i class="${"ri-star-fill"}"></i>
								<i class="${"ri-star-fill"}"></i>
								<i class="${"ri-star-fill"}"></i>
								...
								<i class="${"ri-star-line"}"></i></div></div>
						<div class="${"text-end mb-0 text-muted"}">- by <cite title="${"Source Title"}">Nancy Martino</cite></div></div></div>`;
                }
              })}`;
            }
          })}`;
...
var img8 = "/_app/assets/img-8-c0552a55.png";
        ...
        default: () => {
          return `<div class="${"p-3"}"><h6 class="${"text-muted mb-0 text-uppercase fw-semibold"}">Recent Activity
						...
						<div class="${"acitivity-item py-3 d-flex"}"><div class="${"flex-shrink-0 avatar-xs acitivity-avatar"}"><div class="${"avatar-title bg-soft-danger text-danger rounded-circle"}"><i class="${"ri-stack-fill"}"></i></div></div>
							<div class="${"flex-grow-1 ms-3"}"><h6 class="${"mb-1 lh-base"}">Added new${escape(" ")}
								...
								<div class="${"d-inline-flex gap-2 border border-dashed p-2 mb-2"}"><a href="${"/ecommerce/apps-ecommerce-product-details"}" class="${"bg-light rounded p-1"}"><img${add_attribute("src", img8, 0)} alt="${""}" class="${"img-fluid d-block"}"></a>
									<a href="${"/ecommerce/apps-ecommerce-product-details"}" class="${"bg-light rounded p-1"}"><img${add_attribute("src", img2$1, 0)} alt="${""}" class="${"img-fluid d-block"}"></a>
									<a href="${"/ecommerce/apps-ecommerce-product-details"}" class="${"bg-light rounded p-1"}"><img${add_attribute("src", img1, 0)} alt="${""}" class="${"img-fluid d-block"}"></a></div>
				...
				<div class="${"p-3 mt-2"}"><h6 class="${"text-muted mb-3 text-uppercase fw-semibold"}">Top 10 Categories
					...
					<ol class="${"ps-3 text-muted"}">${each$1(MOCK_DATA.topCategories, (item) => {
