...
const GradientDonut = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { dataColors } = $$props;
  if ($$props.dataColors === void 0 && $$bindings.dataColors && dataColors !== void 0)
    $$bindings.dataColors(dataColors);
  return `<div id="${"gradientdountpiechart"}" class="${"apex-charts"}" dir="${"ltr"}"></div>`;
});
export { GradientDonut as default };
