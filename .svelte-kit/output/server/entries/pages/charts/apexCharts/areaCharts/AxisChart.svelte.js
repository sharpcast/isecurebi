...
const AxisChart = create_ssr_component(($$result, $$props, $$bindings, slots) => {
      ...
      yaxis: [
        {
          ...
          label: {
            show: true,
            text: "Support",
            style: { color: "#fff", background: "#e83e8c" }
          }
        }
      ],
      xaxis: [
  ...
  return `<div id="${"axixchart"}" class="${"apex-charts"}" dir="${"ltr"}"></div>`;
});
export { AxisChart as default };
