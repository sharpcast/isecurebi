...
const ChartSyncingLine = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { dataColors } = $$props;
  function getChartColorsArray(colors) {
  }
  var chartSyncingColors = getChartColorsArray();
  ({
    chart: {
      id: "fb",
      group: "social",
  ...
  return `<div id="${"Syncingline"}" class="${"apex-charts"}" dir="${"ltr"}"></div>`;
});
export { ChartSyncingLine as default };
