...
const ZoomableTimeseries = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { dataColors } = $$props;
  function getChartColorsArray(colors) {
  }
  var ZoomableTimeseriesColors = getChartColorsArray();
  ({
    chart: {
      type: "area",
      stacked: false,
  ...
  return `<div id="${"line_chart_zoomable"}" class="${"apex-charts"}" dir="${"ltr"}"></div>`;
});
export { ZoomableTimeseries as default };
