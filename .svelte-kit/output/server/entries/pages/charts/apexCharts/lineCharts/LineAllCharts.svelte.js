...
const LineAllCharts = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { dataColors } = $$props;
  if ($$props.dataColors === void 0 && $$bindings.dataColors && dataColors !== void 0)
    $$bindings.dataColors(dataColors);
  return `<div id="${"lineallcharts"}" class="${"apex-charts"}" dir="${"ltr"}"></div>`;
});
export { LineAllCharts as default };
