...
const CandlestickLine = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { dataColors } = $$props;
  if ($$props.dataColors === void 0 && $$bindings.dataColors && dataColors !== void 0)
    $$bindings.dataColors(dataColors);
  return `<div id="${"candlestickline"}" class="${"apex-charts"}" dir="${"ltr"}"></div>`;
});
export { CandlestickLine as default };
