...
const Trading = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let activeTab = 1;
      ...
      return `${validate_component(Card, "Card").$$render($$result, {}, {}, {
        default: () => {
          return `${validate_component(CardHeader, "CardHeader").$$render($$result, {
            class: "align-items-center border-0 d-flex"
          }, {}, {
            default: () => {
              return `<h4 class="${"card-title mb-0 flex-grow-1"}">Trading</h4>
			<div class="${"flex-shrink-0"}">${validate_component(Nav, "Nav").$$render($$result, {
		...
		${validate_component(CardBody, "CardBody").$$render($$result, { class: "p-0" }, {}, {
            default: () => {
              return `${validate_component(TabContent, "TabContent").$$render($$result, { class: "p-0" }, {}, {
                default: () => {
					...
					<div class="${"p-3"}">${validate_component(Row, "Row").$$render($$result, {}, {}, {
                        ...
                        default: () => {
                          return `Total`;
								...
								<input type="${"text"}" class="${"form-control"}" placeholder="${"2700.16"}"></div></div>
                              ...
                              return `<div class="${"mb-3"}">${validate_component(Label, "Label").$$render($$result, {}, {}, {
                                default: () => {
                                  return `Email :`;
									...
									<input type="${"email"}" class="${"form-control"}" placeholder="${"example@email.com"}"></div>`;
                            }
                          })}`;
                        }
                      })}
