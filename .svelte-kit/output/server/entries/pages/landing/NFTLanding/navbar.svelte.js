...
const Navbar = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let navClass = "";
  let isOpen = true;
  return `<nav${add_attribute("class", "navbar navbar-expand-lg navbar-landing navbar-light fixed-top " + navClass, 0)} id="${"navbar"}">${validate_component(Container, "Container").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(Link, "Link").$$render($$result, {
        ...
        default: () => {
          return `<div class="${"navbar-nav mx-auto mt-2 mt-lg-0 active"}" id="${"navbar-example"}"><li class="${"nav-item"}">${validate_component(NavLink, "NavLink").$$render($$result, { href: "#hero" }, {}, {
            default: () => {
              return `Home`;
            }
          })}</li>
                <li class="${"nav-item"}">${validate_component(NavLink, "NavLink").$$render($$result, { href: "#wallet" }, {}, {
            default: () => {
              return `Wallet`;
            }
          })}</li>
                <li class="${"nav-item"}">${validate_component(NavLink, "NavLink").$$render($$result, { href: "#marketplace" }, {}, {
            default: () => {
              return `Marketplace`;
            }
          })}</li>
            ...
            default: () => {
              return `Categories`;
                ...
                <li class="${"nav-item"}">${validate_component(NavLink, "NavLink").$$render($$result, { href: "#creators" }, {}, {
            default: () => {
              return `Creators`;
            }
          })}</li></div>
            ...
            href: "/crypto/mywallet/apps-crypto-wallet",
