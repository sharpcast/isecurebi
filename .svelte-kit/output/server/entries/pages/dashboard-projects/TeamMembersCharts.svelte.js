...
const TeamMembersCharts = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.id === void 0 && $$bindings.id && id !== void 0)
    $$bindings.id(id);
  return `<div${add_attribute("id", "teammemberscharts" + id, 0)} class="${"apex-charts"}" dir="${"ltr"}"></div>`;
});
export { TeamMembersCharts as default };
