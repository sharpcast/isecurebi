...
const JobSummary = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { dataColors } = $$props;
  if ($$props.dataColors === void 0 && $$bindings.dataColors && dataColors !== void 0)
    $$bindings.dataColors(dataColors);
  return `${validate_component(Col, "Col").$$render($$result, { xxl: 8, md: 6 }, {}, {
    default: () => {
      return `${validate_component(Card, "Card").$$render($$result, { class: "card-height-100" }, {}, {
        default: () => {
          return `${validate_component(CardHeader, "CardHeader").$$render($$result, { class: "align-items-center d-flex" }, {}, {
            default: () => {
              return `<h4 class="${"card-title mb-0 flex-grow-1"}">Jobs Summary</h4>
                  ...
                  return `${validate_component(DropdownToggle, "DropdownToggle").$$render($$result, {
                    ...
                    default: () => {
                      return `<span class="${"fw-semibold text-uppercase fs-12"}">Sort by:${escape(" ")}</span>
                        <span class="${"text-muted"}">Current Year
        ...
        ${validate_component(CardBody, "CardBody").$$render($$result, { class: "card-body px-0" }, {}, {
            default: () => {
              return `<div id="${"jobsummary"}" class="${"apex-charts"}" dir="${"ltr"}"></div>`;
            }
          })}`;
        }
      })}`;
