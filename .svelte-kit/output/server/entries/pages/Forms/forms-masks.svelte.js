...
const Forms_masks = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `${$$result.head += `${$$result.title = `<title>Input Mask | Velzon - Svelte Admin &amp; Dashboard Template</title>`, ""}`, ""}


<div class="${"page-content"}">${validate_component(Container, "Container").$$render($$result, { fluid: true }, {}, {
    default: () => {
      return `${validate_component(BreadCrumb, "BreadCrumb").$$render($$result, { title: "Input Masks", pageTitle: "Forms" }, {}, {})}
              ...
              return `${validate_component(Card, "Card").$$render($$result, {}, {}, {
                default: () => {
                  return `${validate_component(CardHeader, "CardHeader").$$render($$result, {}, {}, {
                    default: () => {
                      return `<h4 class="${"card-title mb-0"}">Examples</h4>`;
                    }
                  })}

					${validate_component(CardBody, "CardBody").$$render($$result, {}, {}, {
                    default: () => {
                      return `<form action="${"#"}"><div><h5 class="${"fs-14 mb-3 text-muted"}">Date Formatting</h5>
								${validate_component(Row, "Row").$$render($$result, {}, {}, {
                        default: () => {
                          return `${validate_component(Col, "Col").$$render($$result, { xl: 6 }, {}, {
                            default: () => {
                              return `<div class="${"mb-3"}">${validate_component(Label, "Label").$$render($$result, { for: "cleave-date", class: "form-label" }, {}, {
                                default: () => {
                                  return `Date`;
                                }
                              })}
											<input placeholder="${"DD-MM-YYYY"}" class="${"form-control"}"></div>`;
                            }
                          })}
                              ...
                              return `<div class="${"mb-3"}">${validate_component(Label, "Label").$$render($$result, {
                                ...
                                default: () => {
                                  return `Date Formatting`;
											...
											<input placeholder="${"MM/YY"}" class="${"form-control"}"></div>`;
                            }
                          })}`;
                        }
                      })}</div>
							...
							<div class="${"mt-4"}"><h6 class="${"mb-3 fs-14 text-muted"}">Time Formatting</h6>
								${validate_component(Row, "Row").$$render($$result, {}, {}, {
                        default: () => {
                          return `${validate_component(Col, "Col").$$render($$result, { xl: 6 }, {}, {
                            default: () => {
                              return `<div class="${"mb-3"}">${validate_component(Label, "Label").$$render($$result, { for: "cleave-time", class: "form-label" }, {}, {
                                default: () => {
                                  return `Time`;
                                }
                              })}
											<input placeholder="${"hh:mm:ss"}" class="${"form-control"}"></div>`;
                            }
                          })}
                              ...
                              return `<div class="${"mb-3"}">${validate_component(Label, "Label").$$render($$result, {
                                ...
                                default: () => {
                                  return `Time Formatting`;
											...
											<input placeholder="${"hh:mm"}" class="${"form-control"}"></div>`;
                            }
                          })}`;
                        }
                      })}</div>
							...
							<div class="${"mt-4"}"><h5 class="${"fs-14 mb-3 text-muted"}">Custom Options</h5>
								${validate_component(Row, "Row").$$render($$result, {}, {}, {
                        default: () => {
                          return `${validate_component(Col, "Col").$$render($$result, { xl: 6 }, {}, {
                            default: () => {
                              return `<div class="${"mb-3"}">${validate_component(Label, "Label").$$render($$result, { for: "cleave-ccard", class: "form-label" }, {}, {
                                default: () => {
                                  return `Credit Card`;
                                }
                              })}
											<input placeholder="${"xxxx xxxx xxxx xxxx"}" class="${"form-control"}"></div>`;
                            }
                          })}
                              ...
                              return `<div class="${"mb-3"}">${validate_component(Label, "Label").$$render($$result, {
                                ...
                                default: () => {
                                  return `Delimiter`;
											...
											<input placeholder="${"xxx\xB7xxx\xB7xxx"}" class="${"form-control"}"></div>`;
                            }
                          })}`;
                        }
                      })}
                              ...
                              return `<div class="${"mb-3"}">${validate_component(Label, "Label").$$render($$result, {
                                ...
                                default: () => {
                                  return `Delimiters`;
											...
											<input placeholder="${"xxx.xxx.xxx-xx"}" class="${"form-control"}"></div>`;
                            }
                          })}
