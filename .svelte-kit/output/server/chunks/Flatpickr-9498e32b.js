import { c as create_ssr_component, h as compute_rest_props, p as createEventDispatcher, j as spread, k as escape_object, d as add_attribute } from "./index-584434b3.js";
const HOOKS = [
  "onChange",
  "onClose",
  "onDayCreate",
...
const Flatpickr = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  function updateValue(newValue, dateStr, fp2) {
    const mode = fp2?.config?.mode ?? "single";
